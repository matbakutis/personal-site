		...
		return (
			<div className="page">
				...
				<div className="aboutContent">
					...
					<img className="portrait" src="portrait.jpg" alt="Self Portrait" />
					<img className="portraitLandscape" src="portraitLandscape.jpg" alt="Self Portrait Landscape" />
				</div>			
			</div>
		)
	}
